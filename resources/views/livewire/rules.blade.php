<x-ui-page>
    ...
    <x-ui-page-container>
        ...
        {{-- Test/Apply Feedback --}}
        @if($testResult)
            <div class="mb-4 px-4 py-3 rounded-2xl bg-blue-50 border border-blue-200 text-[13px] text-blue-800">
                {{ $testResult }}
            </div>
        @endif
            ...
            <div class="lg:col-span-2">
                ...
                @else
                    <div class="bg-white rounded-2xl shadow-sm p-12 text-center">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 mb-1">Noch keine Regeln</h3>
