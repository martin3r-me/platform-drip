            ...
            <div class="lg:col-span-2">
                ...
                @if($activeTab === 'suggestions')
                    <div class="flex items-center justify-between mb-3">
                        <h3 class="text-xl font-bold text-gray-900">Erkannte Muster</h3>
                    ...
                    @else
                        <div class="bg-white rounded-2xl shadow-sm p-12 text-center">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mb-1">Keine Vorschlaege</h3>
                ...
                @if($activeTab === 'active')
                    @if(count($budgets) > 0)
                        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                            @foreach($budgets as $index => $b)
                                <div class="flex items-center justify-between px-6 py-4 {{ $index < count($budgets) - 1 ? 'border-b border-gray-100' : '' }} {{ $b['status'] === 'paused' ? 'opacity-50' : '' }}">
                            ...
                            <div class="mt-4 bg-white rounded-2xl shadow-sm overflow-hidden">
                                ...
                                <div class="divide-y divide-gray-100">
                                    @foreach($periods as $p)
                                        <div class="flex items-center justify-between px-6 py-3 {{ $p['status'] === 'skipped' ? 'opacity-40 line-through' : '' }}">
                        ...
                        @elseif($showPeriodsFor && count($periods) === 0)
                            <div class="mt-3 bg-white rounded-2xl shadow-sm p-6 text-center">
                    ...
                    @else
                        <div class="bg-white rounded-2xl shadow-sm p-12 text-center">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mb-1">Noch keine Budgets</h3>
                ...
                @if($activeTab === 'history')
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-xl font-bold text-gray-900 w-36 text-center">{{ $historyMonthLabel }}</span>
                    ...
                    @if(count($historyBudgets) > 0)
                        <div class="bg-white rounded-2xl shadow-sm overflow-hidden">
                            @foreach($historyBudgets as $index => $b)
                                ...
                                @endphp
                                <div class="flex items-center justify-between px-6 py-4 {{ $index < count($historyBudgets) - 1 ? 'border-b border-gray-100' : '' }}">
                                    <div class="flex-1 min-w-0 mr-4">
                                        <div class="flex items-center gap-2 mb-1.5">
                                            <div class="w-2.5 h-2.5 rounded-full shrink-0" style="background-color: {{ $b['category_color'] }}"></div>
                                            <span class="text-sm font-medium text-gray-900 truncate">{{ $b['name'] }}</span>
                    ...
                    @else
                        <div class="bg-white rounded-2xl shadow-sm p-12 text-center">
                            ...
                            <h3 class="text-xl font-bold text-gray-900 mb-1">Keine Daten</h3>
